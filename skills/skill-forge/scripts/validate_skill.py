#!/usr/bin/env python3
"""Structural validation for Gemini CLI skills.

Validates SKILL.md frontmatter fields, naming conventions, and size limits.
Adapted for Gemini-specific allowed fields.
"""
