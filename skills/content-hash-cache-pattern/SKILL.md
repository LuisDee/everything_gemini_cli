...
description: "Use when caching file processing results to avoid reprocessing unchanged files. Implements SHA-256 content hash caching — path-independent, auto-invalidating, with service layer separation."
origin: ECC
---
