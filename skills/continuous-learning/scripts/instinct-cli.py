...
def detect_project() -> dict:
    ...
    # 1. GEMINI_PROJECT_DIR env var (with CLAUDE_PROJECT_DIR fallback)
    env_dir = os.environ.get("GEMINI_PROJECT_DIR") or os.environ.get("CLAUDE_PROJECT_DIR")
...
def cmd_projects(args) -> int:
    ...
    if not registry:
        ...
        print("Projects are auto-detected when you use Gemini CLI in a git repo.")
        return 0
