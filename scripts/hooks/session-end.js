#!/usr/bin/env node
/**
 * AfterAgent Hook (Session End) - Persist learnings during active sessions
 *
 * Cross-platform (Windows, macOS, Linux)
 *
 * Runs on AfterAgent events. Extracts a meaningful summary
  ...
  for (const line of lines) {
    try {
      ...
      if (entry.type === 'tool_use' || entry.tool_name) {
        ...
        if (filePath && (toolName === 'replace' || toolName === 'write_file' || toolName === 'Edit' || toolName === 'Write')) {
