 ...
 *
 * Detection priority:
 * 1. Environment variable GEMINI_PACKAGE_MANAGER (or CLAUDE_PACKAGE_MANAGER fallback)
...
function getPackageManager(options = {}) {
  ...
  const envPm = process.env.GEMINI_PACKAGE_MANAGER || process.env.CLAUDE_PACKAGE_MANAGER;
